...
class Profile(models.Model):
    profile = models.OneToOneField(Account, on_delete=models.CASCADE, primary_key=True)
    tech_stack = models.CharField(max_length=255, null=True, blank=True)
    learning = models.CharField(max_length=255, null=True, blank=True)
    ...
    tvshows=models.CharField(max_length=255, null=True, blank=True)
